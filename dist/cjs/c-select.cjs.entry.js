...
const CSelect = class {
  constructor(hostRef) {
    ...
    this._getListItem = (item, index$1) => {
      ...
      return (index.h("li", Object.assign({}, a11y, { id: itemId, ref: (el) => this._itemRefs.push({ value: item.value, ref: el }), class: classes, onClick: (event) => this._select(event, item) }), item.name));
    };
