...
const CMenu = class {
  constructor(hostRef) {
    ...
    this._uniqueId = `c-menu-items-${v4.v4()}`;
    this.items = [];
    this.simple = false;
    this.small = false;
    this.nohover = false;
  ...
  _renderCustomTrigger() {
    ...
    return (index.h(Tag, Object.assign({}, params, { class: "custom-menu-trigger", "aria-expanded": this.active.toString(), "aria-haspopup": "listbox", "aria-controls": this._uniqueId, onClick: () => this._onClick() }), props.value));
  }
  render() {
    const hostClasses = {
      'c-menu': true,
    ...
    return (index.h(index.Host, { class: hostClasses }, this.customTrigger ? (this._renderCustomTrigger()) : (index.h("button", { "aria-expanded": this.active.toString(), "aria-haspopup": "listbox", "aria-controls": this._uniqueId, class: {
