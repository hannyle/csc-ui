...
const CCheckbox = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: wrapperClasses }, index.h("input", { class: "visuallyhidden", id: "checkbox", type: "checkbox", "aria-checked": (!!this.value).toString(), "aria-disabled": this.disabled.toString(), checked: this.value, disabled: this.disabled, onChange: (event) => this.toggleState(event) }), index.h("label", { class: labelClasses, htmlFor: "checkbox" }, index.h("div", { class: "ripple", ref: (el) => (this._container = el) }, index.h("svg", { viewBox: "0 0 100 100" }, !this.intermediate && !!this.value && (index.h("path", { class: "path", d: "M 12 52 l 24 24 l 47 -47 l -3 -3 l -44 44 l -21 -21 l -3 3" })), this.intermediate && (index.h("path", { class: "path", d: "M20 56 h60 v-8 h-60 z" })))), index.h("div", { class: "c-checkbox__label-content" }, !!this.label ? this.label : index.h("slot", null), this.required && index.h("span", { class: "required" }, "\u00A0*")))), this._renderMessages()));
  }
...
const CPagination = class {
  ...
  render() {
    ...
    return (index.h("nav", { class: classes, role: "navigation", "aria-label": "pagination" }, !this.hideDetails && (index.h("div", { class: "c-pagination__details" }, this._getItemsPerPage(), index.h("span", { class: { range: !this.simple } }, this._getRange()))), index.h("ul", null, this._getArrowLeft(buttonsize), !this.simple && this._getPageButtons(buttonsize), this._getArrowRight(buttonsize))));
  }
  static get watchers() { return {
    "value": ["valueHandler"]
  }; }
