...
const CRadioGroup = class {
  constructor(hostRef) {
    ...
    this._getRadioButton = (item, index$1) => {
      ...
      return (index.h("label", { class: classes, id: itemId, onKeyDown: (event) => this._handleKeyDown(event, item, index$1) }, index.h("input", { type: "radio", "aria-checked": (this.value === item).toString(), "aria-disabled": this.disabled.toString(), "aria-labelledby": itemId, disabled: this.disabled, checked: isChecked, name: this._uniqueId, onChange: (event) => this._select(event, item, index$1) }), index.h("span", { class: "ripple", ref: (el) => (this._containers[index$1] = el) }, index.h("span", { class: "selection" })), index.h("div", { class: "c-radio__label" }, item.label)));
    };
